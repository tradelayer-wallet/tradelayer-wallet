...
/* @algo
{
  ...
  "mode": "FUTURES",
  "name": "Moneyball nbx_lb240_d24_w140_minw80_md45_both_non_us_hit",
  "parameters": {
    "family": "no_btc_sideways_range_cross",
    "metrics": {
      "ev": 1.127903,
      "max_drawdown": 12.148382,
      "months": 36,
      "net": 76.697375,
      "p95_mae_bps": 17.871417,
      "positive_months": 29,
      "trades": 68,
      "worst_month": -7.170452
    },
...
const SYSTEM = {
  ...
  "family": "no_btc_sideways_range_cross",
  "id": "nbx_lb240_d24_w140_minw80_md45_both_non_us_hit",
  "market": "ETH/USD",
  "metrics": {
    "ev": 1.127903,
    "max_drawdown": 12.148382,
  ...
  "spec": {
    ...
    "range_cross_max_drift_frac": 0.24,
    ...
    "side_mode": "BOTH",
    "stop_type": "trailing",
    "strategy_id": "nbx_lb240_d24_w140_minw80_md45_both_non_us_hit",
    "strategy_type": "sideways_range_cross",
    "trail_pct_bps": 15.0,
    "trail_timeframe": "1m"
  },
  "spec_path": "portfolio_candidates/no_btc_range_cross_adapter_specs/nbx_lb240_d24_w140_minw80_md45_both_non_us_hit.json",
  "status": "adapter_parity_validated"
};
