...
/* @algo
{
  ...
  "mode": "FUTURES",
  "name": "Moneyball post_impulse_shelf_reclaim_00006_best_sparse",
  "parameters": {
...
const SYSTEM = {
  ...
  "family": "post_impulse_shelf_reclaim",
  "id": "post_impulse_shelf_reclaim_00006_best_sparse",
  "market": "ETH/USD",
  "metrics": {
    "avg": 1.078295,
    "max_dd": 58.107352,
  ...
  "spec": {
    ...
    "side_mode": "BOTH",
    "stop_type": "trailing",
    "strategy_id": "post_impulse_shelf_reclaim_00006_best_sparse",
    "strategy_type": "post_impulse_shelf_reclaim",
    "trail_pct_bps": 15.0,
    "trail_timeframe": "1m"
  },
  "spec_path": "portfolio_candidates/post_impulse_shelf_reclaim_adapter_specs/post_impulse_shelf_reclaim_00006_best_sparse.json",
  "status": "research_promoted_adapter_partial_parity"
};
