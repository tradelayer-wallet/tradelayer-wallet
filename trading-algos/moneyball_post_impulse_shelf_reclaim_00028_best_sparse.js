...
/* @algo
{
  ...
  "mode": "FUTURES",
  "name": "Moneyball post_impulse_shelf_reclaim_00028_best_sparse",
  "parameters": {
...
const SYSTEM = {
  ...
  "family": "post_impulse_shelf_reclaim",
  "id": "post_impulse_shelf_reclaim_00028_best_sparse",
  "market": "ETH/USD",
  "metrics": {
    "avg": 1.191218,
    "max_dd": 106.343499,
  ...
  "spec": {
    ...
    "shelf_signal_tf": "5m",
    "shelf_target_loc_frac": 1.35,
    "side_mode": "BOTH",
    "stop_type": "trailing",
    "strategy_id": "post_impulse_shelf_reclaim_00028_best_sparse",
    "strategy_type": "post_impulse_shelf_reclaim",
    "trail_pct_bps": 15.0,
    "trail_timeframe": "1m"
  },
  "spec_path": "portfolio_candidates/post_impulse_shelf_reclaim_adapter_specs/post_impulse_shelf_reclaim_00028_best_sparse.json",
  "status": "research_promoted_adapter_partial_parity"
};
